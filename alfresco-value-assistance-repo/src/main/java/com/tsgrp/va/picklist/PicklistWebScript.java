...
/**
 * Returns picklist values based on the provided parameters. Also provides labels given a value for dynamic picklist labels. 
 *  
 ...
 * </ul>
 * <p>Copyright &copy; 2013 Technology Services Group, Inc.</p> 
 */
public class PicklistWebScript extends DeclarativeWebScript
{
    ...
    protected void process(WebScriptRequest req, Map<String, Object> model) throws Exception
    {
		...
		else
		{
			...
			query2.append(" AND TYPE:\"" + ValueAssistanceModel.TSG_VALUE_ASSISTANCE_MODEL_PREFIX + ":" + ValueAssistanceModel.TYPE_VALUE_ASSISTANCE_LIST_ITEM.getLocalName() + "\"");
